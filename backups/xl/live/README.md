...
> 前提：因为现行的xx直播PC框架在当时要兼容IE8的大环境下加入了许多兼容性代码，前端架构也因此受限而无法使用市场上其他成熟的框架和解决方案。随着项目需求不断迭代，也因市场上越来越多高效解决方案的出现，xx直播前端团队进行调研能够满足现在业务需求并且能提高页面性能和代码效率的新框架方案。

### 分析
1. 现有框架情况：

   jQuery+template+webpack
2. 新框架要求：
...
- 建议选择**Vue.js+nuxt**
   ...
   2. nuxt方便的配置，简化了繁琐的修改配置流程，集成了Vuex、webpack、babel等功能，满足已有的xx直播需求，能够把人力从繁琐的配置中解放出来研究具体的业务。
   3. 丰富的中文社区，以及PCxx前端同事已经有多年沉淀Vue的经验可以交流。
